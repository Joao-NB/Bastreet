...
const regionalPreview=[
  ...
  {id:'olinda-vila-olimpica',name:'Vila Olímpica de Rio Doce',area:'Rio Doce',lat:-7.9591785,lon:-34.8470931,light:true,surface:'Quadra poliesportiva',open:'Consulte os horários',source:'regional'},
  {id:'olinda-milton-pina',name:'Quadra Poliesportiva Milton Pina',area:'Bultrins',lat:-7.9975092,lon:-34.8498435,light:true,surface:'Quadra poliesportiva',open:'Não informado',source:'regional'},
  {id:'olinda-ouro-preto',name:'Quadra de Basquete de Ouro Preto',area:'Ouro Preto',lat:-7.9872912,lon:-34.8578441,light:false,surface:'Quadra comunitária',open:'Não informado',source:'regional'}
];
let courts = [];
