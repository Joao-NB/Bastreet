...
const db={users,sessions:[],trainings:[],checkins:[],messages:[{id:crypto.randomUUID(),userId:'bot',userName:'Rafael (bot)',text:'Ambiente preparado! Entrem com as quatro contas e busquem uma partida.',createdAt:new Date().toISOString()}],queue:[],matches:[]};
